...
export async function ensureSchema() {
  ...
  schemaReady = (async () => {
    ...
    // LƯU Ý: probe phải là CẤU TRÚC MỚI NHẤT. Hiện tại: cột backlog_items.task_id.
    try {
      await sql`SELECT task_id FROM backlog_items LIMIT 0`;
    ...
    // Task BA được sinh ra từ hạng mục này (nối chuỗi giá trị PO -> BA)
